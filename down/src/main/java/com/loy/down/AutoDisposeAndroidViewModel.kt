...
/**
 *@Author loy
 *创建时间：2021/8/18 16:09
 *description:
 */
/**
 * Demo base [ViewModel] that can automatically dispose itself in [onCleared].
 */
abstract class AutoDisposeAndroidViewModel(application: Application) : AndroidViewModel(application),
    LifecycleScopeProvider<AutoDisposeAndroidViewModel.ViewModelEvent> {
